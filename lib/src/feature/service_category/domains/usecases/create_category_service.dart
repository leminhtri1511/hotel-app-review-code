...
class CreateCategoryServiceUseCase {
  CreateCategoryServiceUseCase(this.repository);

  JsonPlaceHolderCategoryServiceRepository repository;

  FeatureResponse<ResponseCategoryServiceModelData, NetworkError> call(
    CreateCategoryServiceModel model,
  ) {
    return repository.createCategoryService(model);
  }
}
